	...
	[2] = {
		...
		dungeon = {
			[1] = {
				...
				keywords = {"랜덤", "랜영", "무작던전", "무작영던", "무작영웅", "무작스핀", "12스핀", "12영웅", "12영던"},
				heroickeywords = {"랜영", "무작영던", "무작영웅", "영던스핀", "12영던", "12영웅"},
			},
			[2] = {
				name = "영혼의 제련소",
...
FP_DIFFICULTY_IGNORE_KEYWORDS = {
	...
	--기타 오인식 문자열 제거
	"10/", "10렙", "10레벨", "250", "25일", "25렙", "25레벨", "1레벨", "1렙", "LV.25", "하드X", "10하드", "티탄X"
}
